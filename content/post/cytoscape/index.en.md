...
A network diagram creation tool.
This is a browser-based implementation of Cytoscape, which is popular as a desktop application.
...
- 1. Load network data...Import node and edge information from network data in GEXF or GraphML format.
- 2. Draw the network...Render the network in Cytoscape and apply automatic layout to organize it.
- 3. Set attributes and customize...Assign attributes to nodes/edges and map them to visual styles such as color and size.
- 4. Export and share...Export the visualization as an SVG image.
